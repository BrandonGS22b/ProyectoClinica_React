...
function FormOrdenRemision(props) {
    const { onSave, OrdenRemision, showButtons = true } = props;
                ...
                <form className="border p-6 rounded shadow bg-body my-3" onSubmit={handleSubmit}>
                        ...
                        <div className="row g-1">
                            ...
                            <div className="col-md-6">
                                ...
                                <select disabled className="form-control" id="medicoEspecialidad" name="medico.especialidad" value={formData.medico.especialidad} onChange={handleChange}>
                                    ...
                                    <option value="Cardiólogo">Cardiología</option>
                    ...
                    <fieldset className="border p-3 mt-3">
                        ...
                        <div className="row g-1">
                            ...
                            <div className="col-md-6">
                                <label htmlFor="nombreRemision" className="form-label">Nombre Remision</label>
                                <input required type="text" className="form-control" id="nombreRemision" name="nombreRemision" value={formData.nombreRemision} onChange={handleChange} />
                            </div>
                            <div className="col-md-6">
                                <label htmlFor="codigoRemision" className="form-label">Codigo Remision</label>
                                <input required type="text" className="form-control" id="codigoRemision" name="codigoRemision" value={formData.codigoRemision} onChange={handleChange} />
                            </div>
                            <div className="col-md-6">
                                <label htmlFor="motivo" className="form-label">Motivo</label>
                                <input required type="text" className="form-control" id="motivo" name="motivo" value={formData.motivo} onChange={handleChange} />
                            </div>
                            <div className="col-md-6">
...
export default FormOrdenRemision;